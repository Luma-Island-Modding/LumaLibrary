...
// https://github.com/Valheim-Modding/Jotunn/blob/dev/JotunnLib/Utils/BepInExUtils.cs

namespace LumaLibrary.Utils
{
    public static class BepInExUtils
    {
        ...
        /// <summary>
        ///     Cache loaded plugins which depend on LumaLibrary.
        /// </summary>
        /// <returns></returns>
        private static BaseUnityPlugin[] CacheDependentPlugins()
        {
            ...
            foreach (var plugin in GetLoadedPlugins())
            {
                ...
                if (plugin.Info.Metadata.GUID == Plugin.ModGUID)
                {
                ...
                {
                    if (dependencyAttribute.DependencyGUID == Plugin.ModGUID)
                    {
                        dependent.Add(plugin);
                    }
                }
        ...
        /// <summary>
        ///     Get a dictionary of loaded plugins which depend on Luma.
        /// </summary>
        /// <returns>Dictionary of plugin GUID and <see cref="BaseUnityPlugin"/></returns>
        public static Dictionary<string, BaseUnityPlugin> GetDependentPlugins(bool includeLuma = false)
        {
            if (Plugins == null)
            {
            ...
            return Plugins
                   .Where(plugin => includeLuma || plugin.Info.Metadata.GUID != Plugin.ModGUID)
        ...
        /// </summary>
        /// <returns>Dictionary of plugin GUID and <see cref="BaseUnityPlugin"/></returns>
        public static Dictionary<string, BaseUnityPlugin> GetPlugins(bool includeLuma = false)
        {
        ...
        public static BepInPlugin GetSourceModMetadata()
        {
            ...
            return GetPluginInfoFromType(callingType)?.Metadata ??
                   ...
                   Plugin.LumaInstance.Info.Metadata;
        }
